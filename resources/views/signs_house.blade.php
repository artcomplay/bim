...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta name="description" content="Таблички на дом" />
                    ...
                    <div class="row main-content-row">
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-9 col-xl-9" id="main-space" style="padding-left: 0px;">
                            ...
                            <div class="container-fluid">
                                <div class="market-info" id="m-i-1"><h1>Таблички на дом</h1></div>
                            </div>

                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        <div class=""><img src="image/info-block/home-table.png" alt="" class="gallery-image"></div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        <div class="awi desc-work">
                                            <h4 class="desc-work-title">Адресные таблички:</h4>
                                            ...
                                            <p>- Сроки изготовления: от 1 рабочего дня</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container-fluid main-text-container">
                                <p>Адресные таблички встречаются на домах, общественных зданиях, на них указан номер здания, наименование улицы. Могут выполняться по стандартным проектам для городских улиц или по индивидуальным проектам для загородных домов и частных лиц.
                                </p>
                            </div>
